...
`,[f(`border`,`
 ...
 `,[d(`& +`,[f(`content`,{marginTop:`9px`})])]),f(`content`,{transition:`color .3s var(--n-bezier)`,fontSize:`var(--n-font-size)`})]),f(`icon`,{transition:`color .3s var(--n-bezier)`})]),L={...x.props,title:String,showIcon:{type:Boolean,default:!0},type:{type:String,default:`default`},bordered:{type:Boolean,default:!0},closable:Boolean,onClose:Function,onAfterLeave:Function,onAfterHide:Function},R=i({name:`Alert`,inheritAttrs:!1,props:L,slots:Object,setup(e){let{mergedClsPrefixRef:t,mergedBorderedRef:n,inlineThemeDisabled:i,mergedRtlRef:a}=_(e),o=x(`Alert`,`-alert`,I,F,e,t),l=w(`Alert`,a,t),u=r(()=>{let{common:{cubicBezierEaseInOut:t},self:n}=o.value,{fontSize:r,borderRadius:i,titleFontWeight:a,lineHeight:s,iconSize:c,iconMargin:l,iconMarginRtl:u,closeIconSize:d,closeBorderRadius:f,closeSize:p,closeMargin:m,closeMarginRtl:h,padding:_}=n,{type:v}=e,{left:y,right:b}=C(l);return{"--n-bezier":t,"--n-color":n[g(`color`,v)],"--n-close-icon-size":d,"--n-close-border-radius":f,"--n-close-color-hover":n[g(`closeColorHover`,v)],"--n-close-color-pressed":n[g(`closeColorPressed`,v)],"--n-close-icon-color":n[g(`closeIconColor`,v)],"--n-close-icon-color-hover":n[g(`closeIconColorHover`,v)],"--n-close-icon-color-pressed":n[g(`closeIconColorPressed`,v)],"--n-icon-color":n[g(`iconColor`,v)],"--n-border":n[g(`border`,v)],"--n-title-text-color":n[g(`titleTextColor`,v)],"--n-content-text-color":n[g(`contentTextColor`,v)],"--n-line-height":s,"--n-border-radius":i,"--n-font-size":r,"--n-title-font-weight":a,"--n-icon-size":c,"--n-icon-margin":l,"--n-icon-margin-rtl":u,"--n-close-size":p,"--n-close-margin":m,"--n-close-margin-rtl":h,"--n-padding":_,"--n-icon-margin-left":y,"--n-icon-margin-right":b}}),d=i?c(`alert`,r(()=>e.type[0]),u,e):void 0,f=s(!0),p=()=>{let{onAfterLeave:t,onAfterHide:n}=e;t&&t(),n&&n()};return{rtlEnabled:l,mergedClsPrefix:t,mergedBordered:n,visible:f,handleCloseClick:()=>{Promise.resolve(e.onClose?.()).then(e=>{e!==!1&&(f.value=!1)})},handleAfterLeave:()=>{p()},mergedTheme:o,cssVars:i?void 0:u,themeClass:d?.themeClass,onRender:d?.onRender}},render(){return this.onRender?.(),a(),n(v,{onAfterLeave:this.handleAfterLeave},{default:()=>{let{mergedClsPrefix:r,$slots:i}=this,s={class:[`${r}-alert`,this.themeClass,this.closable&&`${r}-alert--closable`,this.showIcon&&`${r}-alert--show-icon`,!this.title&&this.closable&&`${r}-alert--right-adjust`,this.rtlEnabled&&`${r}-alert--rtl`],style:this.cssVars,role:`alert`};return this.visible?(a(),t(`div`,o({key:1},o(this.$attrs,s)),[S(()=>this.closable&&(a(),n(j,{clsPrefix:r,class:y(`${r}-alert__close`),onClick:this.handleCloseClick},null,8,[`clsPrefix`,`class`,`onClick`]))),S(()=>this.bordered&&(a(),t(`div`,{class:y(`${r}-alert__border`)},null,2))),S(()=>this.showIcon&&(a(),t(`div`,{class:y(`${r}-alert__icon`),"aria-hidden":`true`},[S(()=>T(i.icon,()=>[(a(),n(M,{clsPrefix:r},{default:()=>{switch(this.type){case`success`:return a(),n(N,{key:3});case`info`:return a(),n(D,{key:4});case`warning`:return a(),n(O,{key:5});case`error`:return a(),n(A,{key:6});default:return null}}},1032,[`clsPrefix`]))]))],2))),e(`div`,{class:y([`${r}-alert-body`,this.mergedBordered&&`${r}-alert-body--bordered`])},[S(()=>l(i.header,e=>{let n=e||this.title;return n?(a(),t(`div`,{key:2,class:y(`${r}-alert-body__title`)},[S(()=>n)],2)):null})),S(()=>i.default&&(a(),t(`div`,{class:y(`${r}-alert-body__content`)},[S(()=>i.default())],2)))],2)],16)):null}},1032,[`onAfterLeave`])}});export{R as t};