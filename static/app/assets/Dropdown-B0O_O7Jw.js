import{C as e,E as t,F as n,H as r,J as i,L as a,M as o,S as s,St as c,U as l,Y as u,_ as d,_t as f,gt as p,ht as m,it as h,w as g,z as _}from"./endpoints-BqUstzml.js";import{$t as v,A as y,E as b,Jt as x,Qt as S,Xt as C,Zt as w,_t as T,bt as E,in as D,k as O,lt as k,mt as A,ot as j,qt as M,st as N,w as P}from"./Button-D6v1m03e.js";import{a as F,c as I,f as L,i as R,o as z,r as B,s as ee,t as te}from"./create-Be3Nulot.js";import{c as V,n as ne,s as H}from"./Scrollbar-G7EEgfj_.js";import{t as re}from"./use-merged-state-rCtWF78v.js";import{t as ie}from"./format-length-BwSo_EUP.js";import{t as ae}from"./ChevronRight-C0hxIvKt.js";import{E as oe,L as se,R as U,at as W,et as ce,ot as le,rt as ue,st as de,x as fe}from"./index-B0kS2oPz.js";function pe(e={},t){let n=m({ctrl:!1,command:!1,win:!1,shift:!1,tab:!1}),{keydown:i,keyup:a}=e,o=e=>{switch(e.key){case`Control`:n.ctrl=!0;break;case`Meta`:n.command=!0,n.win=!0;break;case`Shift`:n.shift=!0;break;case`Tab`:n.tab=!0}i!==void 0&&Object.keys(i).forEach(t=>{if(t!==e.key)return;let n=i[t];if(typeof n==`function`)n(e);else{let{stop:t=!1,prevent:r=!1}=n;t&&e.stopPropagation(),r&&e.preventDefault(),n.handler(e)}})},s=e=>{switch(e.key){case`Control`:n.ctrl=!1;break;case`Meta`:n.command=!1,n.win=!1;break;case`Shift`:n.shift=!1;break;case`Tab`:n.tab=!1}a!==void 0&&Object.keys(a).forEach(t=>{if(t!==e.key)return;let n=a[t];if(typeof n==`function`)n(e);else{let{stop:t=!1,prevent:r=!1}=n;t&&e.stopPropagation(),r&&e.preventDefault(),n.handler(e)}})},c=()=>{(t===void 0||t.value)&&(V(`keydown`,document,o),V(`keyup`,document,s)),t!==void 0&&h(t,e=>{e?(V(`keydown`,document,o),V(`keyup`,document,s)):(H(`keydown`,document,o),H(`keyup`,document,s))})};return ue()?(r(c),l(()=>{(t===void 0||t.value)&&(H(`keydown`,document,o),H(`keyup`,document,s))})):c(),p(n)}function G(e){return t=>{e.value=t?t.$el:null}}var me=x(`icon`,`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
