...
`,[f(`border`,`
 ...
 `,[d(`& +`,[f(`content`,{marginTop:`9px`})])]),f(`content`,{transition:`color .3s var(--n-bezier)`,fontSize:`var(--n-font-size)`})]),f(`icon`,{transition:`color .3s var(--n-bezier)`})]),L={...x.props,title:String,showIcon:{type:Boolean,default:!0},type:{type:String,default:`default`},bordered:{type:Boolean,default:!0},closable:Boolean,onClose:Function,onAfterLeave:Function,onAfterHide:Function},R=r({name:`Alert`,inheritAttrs:!1,props:L,slots:Object,setup(t){let{mergedClsPrefixRef:r,mergedBorderedRef:i,inlineThemeDisabled:a,mergedRtlRef:o}=_(t),s=x(`Alert`,`-alert`,I,F,t,r),l=w(`Alert`,o,r),u=e(()=>{let{common:{cubicBezierEaseInOut:e},self:n}=s.value,{fontSize:r,borderRadius:i,titleFontWeight:a,lineHeight:o,iconSize:c,iconMargin:l,iconMarginRtl:u,closeIconSize:d,closeBorderRadius:f,closeSize:p,closeMargin:m,closeMarginRtl:h,padding:_}=n,{type:v}=t,{left:y,right:b}=C(l);return{"--n-bezier":e,"--n-color":n[g(`color`,v)],"--n-close-icon-size":d,"--n-close-border-radius":f,"--n-close-color-hover":n[g(`closeColorHover`,v)],"--n-close-color-pressed":n[g(`closeColorPressed`,v)],"--n-close-icon-color":n[g(`closeIconColor`,v)],"--n-close-icon-color-hover":n[g(`closeIconColorHover`,v)],"--n-close-icon-color-pressed":n[g(`closeIconColorPressed`,v)],"--n-icon-color":n[g(`iconColor`,v)],"--n-border":n[g(`border`,v)],"--n-title-text-color":n[g(`titleTextColor`,v)],"--n-content-text-color":n[g(`contentTextColor`,v)],"--n-line-height":o,"--n-border-radius":i,"--n-font-size":r,"--n-title-font-weight":a,"--n-icon-size":c,"--n-icon-margin":l,"--n-icon-margin-rtl":u,"--n-close-size":p,"--n-close-margin":m,"--n-close-margin-rtl":h,"--n-padding":_,"--n-icon-margin-left":y,"--n-icon-margin-right":b}}),d=a?c(`alert`,e(()=>t.type[0]),u,t):void 0,f=n(!0),p=()=>{let{onAfterLeave:e,onAfterHide:n}=t;e&&e(),n&&n()};return{rtlEnabled:l,mergedClsPrefix:r,mergedBordered:i,visible:f,handleCloseClick:()=>{Promise.resolve(t.onClose?.()).then(e=>{e!==!1&&(f.value=!1)})},handleAfterLeave:()=>{p()},mergedTheme:s,cssVars:a?void 0:u,themeClass:d?.themeClass,onRender:d?.onRender}},render(){return this.onRender?.(),s(),a(v,{onAfterLeave:this.handleAfterLeave},{default:()=>{let{mergedClsPrefix:e,$slots:n}=this,r={class:[`${e}-alert`,this.themeClass,this.closable&&`${e}-alert--closable`,this.showIcon&&`${e}-alert--show-icon`,!this.title&&this.closable&&`${e}-alert--right-adjust`,this.rtlEnabled&&`${e}-alert--rtl`],style:this.cssVars,role:`alert`};return this.visible?(s(),t(`div`,o({key:1},o(this.$attrs,r)),[S(()=>this.closable&&(s(),a(j,{clsPrefix:e,class:y(`${e}-alert__close`),onClick:this.handleCloseClick},null,8,[`clsPrefix`,`class`,`onClick`]))),S(()=>this.bordered&&(s(),t(`div`,{class:y(`${e}-alert__border`)},null,2))),S(()=>this.showIcon&&(s(),t(`div`,{class:y(`${e}-alert__icon`),"aria-hidden":`true`},[S(()=>T(n.icon,()=>[(s(),a(M,{clsPrefix:e},{default:()=>{switch(this.type){case`success`:return s(),a(N,{key:3});case`info`:return s(),a(D,{key:4});case`warning`:return s(),a(O,{key:5});case`error`:return s(),a(A,{key:6});default:return null}}},1032,[`clsPrefix`]))]))],2))),i(`div`,{class:y([`${e}-alert-body`,this.mergedBordered&&`${e}-alert-body--bordered`])},[S(()=>l(n.header,n=>{let r=n||this.title;return r?(s(),t(`div`,{key:2,class:y(`${e}-alert-body__title`)},[S(()=>r)],2)):null})),S(()=>n.default&&(s(),t(`div`,{class:y(`${e}-alert-body__content`)},[S(()=>n.default())],2)))],2)],16)):null}},1032,[`onAfterLeave`])}});export{R as t};