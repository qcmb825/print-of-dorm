import{B as e,Bt as t,Ct as n,F as r,Ft as i,H as a,J as o,Nt as s,St as c,Tt as l,U as u,Ut as d,V as f,W as p,X as m,Y as h,_t as g,an as _,f as v,ft as y,in as b,it as x,lt as S,mt as C,p as w,rn as T,st as E}from"./endpoints-C2GocQfh.js";import{A as D,Gt as O,Jt as k,Kt as A,Yt as j,Zt as M,_ as N,b as P,ct as F,d as I,ft as L,g as R,it as z,j as ee,k as B,n as V,nn as H,nt as U,o as W,on as te,rn as G,s as ne,sn as re,st as K,t as q,u as J,ut as ie,v as ae,x as oe}from"./createLucideIcon-Bpd2679P.js";import{t as Y}from"./Input-5-_N6fit.js";import{a as se}from"./Scrollbar-CISmNSMK.js";import{o as ce,t as le}from"./Select-D6c6Amad.js";import{r as ue}from"./cssr-CzADIdCi.js";import{t as de}from"./FormItem-1qYoQ_UO.js";import{n as fe,t as pe}from"./DrawerContent-C89Y5o5S.js";import{t as me}from"./Skeleton-BBqbZ9HY.js";import{t as he}from"./inbox-i5Es5Oga.js";import{t as ge}from"./lock-B7Sp0uFy.js";import{t as _e}from"./plus-BbgcSz1n.js";import{t as ve}from"./send-y1BqhHgP.js";import{C as ye,S as be,U as X,v as xe}from"./index-CK-FFwtZ.js";import{c as Se,y as Ce}from"./format-Ctvw4JoF.js";import{t as we}from"./EmptyState-Bgu14dKD.js";import{t as Te}from"./PageHeader-CcBrnZvZ.js";import{r as Ee,t as De}from"./dist-CIKBL9M3.js";var Oe=m({name:`SlotMachineNumber`,props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(n){let r=i(null),a=i(n.value),o=i(n.value),s=i(`up`),l=i(!1),u=e(()=>l.value?`${n.clsPrefix}-base-slot-machine-current-number--${s.value}-scroll`:null),d=e(()=>l.value?`${n.clsPrefix}-base-slot-machine-old-number--${s.value}-scroll`:null);c(t(n,`value`),(e,t)=>{a.value=t,o.value=e,x(m)});function m(){let e=n.newOriginalNumber,t=n.oldOriginalNumber;t!==void 0&&e!==void 0&&(e>t?h(`up`):t>e&&h(`down`))}function h(e){s.value=e,l.value=!1,x(()=>{r.value?.offsetWidth,l.value=!0})}return()=>{let{clsPrefix:e}=n;return y(),p(`span`,{ref:r,class:z(`${e}-base-slot-machine-number`)},[a.value===null?K(()=>null):(y(),p(`span`,{key:0,class:z([`${e}-base-slot-machine-old-number ${e}-base-slot-machine-old-number--top`,d.value])},[K(()=>a.value)],2)),f(`span`,{class:z([`${e}-base-slot-machine-current-number`,u.value])},[f(`span`,{ref:`numberWrapper`,class:z([`${e}-base-slot-machine-current-number__inner`,typeof n.value!=`number`&&`${e}-base-slot-machine-current-number__inner--not-number`])},[K(()=>o.value)],2)],2),a.value===null?K(()=>null):(y(),p(`span`,{key:2,class:z([`${e}-base-slot-machine-old-number ${e}-base-slot-machine-old-number--bottom`,d.value])},[K(()=>a.value)],2))],2)}}}),{cubicBezierEaseOut:Z}=ie;function ke({duration:e=`.2s`}={}){return[O(`&.fade-up-width-expand-transition-leave-active`,{transition:`
 opacity ${e} ${Z},
 max-width ${e} ${Z},
 transform ${e} ${Z}
