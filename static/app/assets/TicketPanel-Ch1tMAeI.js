import{B as e,H as t,Ht as n,J as r,Mt as i,P as a,Pt as o,St as s,U as c,V as l,Y as u,ct as d,d as f,dt as p,f as m,gt as h,in as g,nn as _,ot as v,pt as y,q as b,rn as x,rt as S,wt as C,xt as w,z as T,zt as E}from"./endpoints-Ba86-U5c.js";import{A as D,Gt as O,Jt as k,Kt as A,Yt as j,Zt as M,_ as N,b as P,ct as F,d as I,ft as L,g as R,it as z,j as ee,k as B,n as V,nn as H,nt as U,o as W,on as te,rn as G,s as ne,sn as re,st as K,t as q,u as J,ut as ie,v as ae,x as oe}from"./createLucideIcon-B5IS4acw.js";import{t as Y}from"./Input-CQyMJYrS.js";import{a as se}from"./Scrollbar-z7pHvvkM.js";import{a as ce,t as le}from"./Select-CFj_PmvN.js";import{r as ue}from"./cssr-HtbsL4tT.js";import{t as X}from"./FormItem-u_5uGMRg.js";import{n as de,t as fe}from"./DrawerContent-C54rhJv2.js";import{t as pe}from"./Skeleton-RbkwCfVU.js";import{t as me}from"./inbox-B7xbg13H.js";import{t as he}from"./lock-BGyVF08S.js";import{t as ge}from"./plus-BqM5cgqC.js";import{t as _e}from"./send-Dx0qRw37.js";import{C as ve,S as Z,V as ye,v as be}from"./index-DOJ_yRfR.js";import{c as xe,y as Se}from"./format-Ctvw4JoF.js";import{t as Ce}from"./EmptyState-EM34F-Cz.js";import{t as we}from"./PageHeader-DtHwRaY1.js";import{r as Te,t as Ee}from"./dist-DzDe2VRF.js";var De=u({name:`SlotMachineNumber`,props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(t){let n=o(null),r=o(t.value),i=o(t.value),a=o(`up`),s=o(!1),l=T(()=>s.value?`${t.clsPrefix}-base-slot-machine-current-number--${a.value}-scroll`:null),u=T(()=>s.value?`${t.clsPrefix}-base-slot-machine-old-number--${a.value}-scroll`:null);w(E(t,`value`),(e,t)=>{r.value=t,i.value=e,S(d)});function d(){let e=t.newOriginalNumber,n=t.oldOriginalNumber;n!==void 0&&e!==void 0&&(e>n?f(`up`):n>e&&f(`down`))}function f(e){a.value=e,s.value=!1,S(()=>{n.value?.offsetWidth,s.value=!0})}return()=>{let{clsPrefix:a}=t;return p(),c(`span`,{ref:n,class:z(`${a}-base-slot-machine-number`)},[r.value===null?K(()=>null):(p(),c(`span`,{key:0,class:z([`${a}-base-slot-machine-old-number ${a}-base-slot-machine-old-number--top`,u.value])},[K(()=>r.value)],2)),e(`span`,{class:z([`${a}-base-slot-machine-current-number`,l.value])},[e(`span`,{ref:`numberWrapper`,class:z([`${a}-base-slot-machine-current-number__inner`,typeof t.value!=`number`&&`${a}-base-slot-machine-current-number__inner--not-number`])},[K(()=>i.value)],2)],2),r.value===null?K(()=>null):(p(),c(`span`,{key:2,class:z([`${a}-base-slot-machine-old-number ${a}-base-slot-machine-old-number--bottom`,u.value])},[K(()=>r.value)],2))],2)}}}),{cubicBezierEaseOut:Q}=ie;function Oe({duration:e=`.2s`}={}){return[O(`&.fade-up-width-expand-transition-leave-active`,{transition:`
 opacity ${e} ${Q},
 max-width ${e} ${Q},
 transform ${e} ${Q}
