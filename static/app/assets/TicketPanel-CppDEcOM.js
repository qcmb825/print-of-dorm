import{$t as e,C as t,Cn as n,D as r,Dn as i,En as a,Hn as o,I as s,L as c,O as l,On as u,Pn as d,Qn as f,Qt as p,R as m,Sn as h,T as g,Wn as _,Xn as v,Yn as y,_ as b,_r as x,_t as S,bn as C,cr as w,dt as T,gn as E,gr as D,ht as O,in as k,l as A,ln as j,lt as ee,m as te,mn as ne,mt as M,nn as N,o as P,or as re,p as ie,pn as ae,pr as F,qn as oe,s as I,tn as se,un as L,v as ce,vr as R,w as le,wn as z,xn as B,yr as V,yt as H,zn as U}from"./endpoints-BjKpicAD.js";import{f as ue,t as W}from"./fade-in-scale-up.cssr-YHRJZfJ_.js";import{d as de}from"./Popover-Da_9Zg5V.js";import{t as G}from"./Empty-BGIXDeRJ.js";import{a as fe,t as pe}from"./Select-BPTcEpAT.js";import{t as K}from"./FormItem-CLCf0LZr.js";import{t as q}from"./Input-CxJ0GnWA.js";import{n as me,t as he}from"./DrawerContent-MDItg_f_.js";import{t as ge}from"./Skeleton-ByR_YrNP.js";import{b as _e,h as ve,y as J}from"./index-C0d_tL2y.js";import{t as Y}from"./createLucideIcon-BtyG49x8.js";import{i as ye,r as be,t as xe}from"./dist-CDiOp3Wx.js";import{t as Se}from"./lock-Ba4xmh9X.js";import{t as Ce}from"./plus-C5xEYaPH.js";import{s as X,u as we}from"./format-DiIJfET2.js";var Z=u({name:`SlotMachineNumber`,props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){let t=w(null),n=w(e.value),r=w(e.value),i=w(`up`),a=w(!1),s=C(()=>a.value?`${e.clsPrefix}-base-slot-machine-current-number--${i.value}-scroll`:null),c=C(()=>a.value?`${e.clsPrefix}-base-slot-machine-old-number--${i.value}-scroll`:null);y(F(e,`value`),(e,t)=>{n.value=t,r.value=e,d(l)});function l(){let t=e.newOriginalNumber,n=e.oldOriginalNumber;n!==void 0&&t!==void 0&&(t>n?u(`up`):n>t&&u(`down`))}function u(e){i.value=e,a.value=!1,d(()=>{t.value?.offsetWidth,a.value=!0})}return()=>{let{clsPrefix:i}=e;return o(),z(`span`,{ref:t,class:T(`${i}-base-slot-machine-number`)},[n.value===null?M(()=>null):(o(),z(`span`,{key:0,class:T([`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--top`,c.value])},[M(()=>n.value)],2)),B(`span`,{class:T([`${i}-base-slot-machine-current-number`,s.value])},[B(`span`,{ref:`numberWrapper`,class:T([`${i}-base-slot-machine-current-number__inner`,typeof e.value!=`number`&&`${i}-base-slot-machine-current-number__inner--not-number`])},[M(()=>r.value)],2)],2),n.value===null?M(()=>null):(o(),z(`span`,{key:2,class:T([`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--bottom`,c.value])},[M(()=>n.value)],2))],2)}}}),{cubicBezierEaseOut:Q}=S;function Te({duration:e=`.2s`}={}){return[p(`&.fade-up-width-expand-transition-leave-active`,{transition:`
 opacity ${e} ${Q},
 max-width ${e} ${Q},
 transform ${e} ${Q}
