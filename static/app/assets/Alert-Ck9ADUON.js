...
`,[g(`border`,`
 ...
 padding-right: 24px;
 `)])]),g(`icon`,{color:`var(--n-icon-color)`}),f(`alert-body`,{padding:`var(--n-padding)`},[g(`title`,{color:`var(--n-title-text-color)`}),g(`content`,{color:`var(--n-content-text-color)`})]),j({originalTransition:`transform .3s var(--n-bezier)`,enterToProps:{transform:`scale(1)`},leaveToProps:{transform:`scale(0.9)`}}),g(`icon`,`
 position: absolute;
 left: 0;
 top: 0;
 align-items: center;
 ...
 `,[T(`& +`,[g(`content`,{marginTop:`9px`})])]),g(`content`,{transition:`color .3s var(--n-bezier)`,fontSize:`var(--n-font-size)`})]),g(`icon`,{transition:`color .3s var(--n-bezier)`})]),L={...x.props,title:String,showIcon:{type:Boolean,default:!0},type:{type:String,default:`default`},bordered:{type:Boolean,default:!0},closable:Boolean,onClose:Function,onAfterLeave:Function,onAfterHide:Function},R=r({name:`Alert`,inheritAttrs:!1,props:L,slots:Object,setup(e){let{mergedClsPrefixRef:n,mergedBorderedRef:r,inlineThemeDisabled:i,mergedRtlRef:a}=C(e),s=x(`Alert`,`-alert`,I,F,e,n),u=v(`Alert`,a,n),d=t(()=>{let{common:{cubicBezierEaseInOut:t},self:n}=s.value,{fontSize:r,borderRadius:i,titleFontWeight:a,lineHeight:o,iconSize:l,iconMargin:u,iconMarginRtl:d,closeIconSize:f,closeBorderRadius:p,closeSize:m,closeMargin:h,closeMarginRtl:g,padding:_}=n,{type:v}=e,{left:y,right:b}=E(u);return{"--n-bezier":t,"--n-color":n[c(`color`,v)],"--n-close-icon-size":f,"--n-close-border-radius":p,"--n-close-color-hover":n[c(`closeColorHover`,v)],"--n-close-color-pressed":n[c(`closeColorPressed`,v)],"--n-close-icon-color":n[c(`closeIconColor`,v)],"--n-close-icon-color-hover":n[c(`closeIconColorHover`,v)],"--n-close-icon-color-pressed":n[c(`closeIconColorPressed`,v)],"--n-icon-color":n[c(`iconColor`,v)],"--n-border":n[c(`border`,v)],"--n-title-text-color":n[c(`titleTextColor`,v)],"--n-content-text-color":n[c(`contentTextColor`,v)],"--n-line-height":o,"--n-border-radius":i,"--n-font-size":r,"--n-title-font-weight":a,"--n-icon-size":l,"--n-icon-margin":u,"--n-icon-margin-rtl":d,"--n-close-size":m,"--n-close-margin":h,"--n-close-margin-rtl":g,"--n-padding":_,"--n-icon-margin-left":y,"--n-icon-margin-right":b}}),f=i?l(`alert`,t(()=>e.type[0]),d,e):void 0,p=o(!0),m=()=>{let{onAfterLeave:t,onAfterHide:n}=e;t&&t(),n&&n()};return{rtlEnabled:u,mergedClsPrefix:n,mergedBordered:r,visible:p,handleCloseClick:()=>{Promise.resolve(e.onClose?.()).then(e=>{e!==!1&&(p.value=!1)})},handleAfterLeave:()=>{m()},mergedTheme:s,cssVars:i?void 0:d,themeClass:f?.themeClass,onRender:f?.onRender}},render(){return this.onRender?.(),a(),i(b,{onAfterLeave:this.handleAfterLeave},{default:()=>{let{mergedClsPrefix:t,$slots:r}=this,o={class:[`${t}-alert`,this.themeClass,this.closable&&`${t}-alert--closable`,this.showIcon&&`${t}-alert--show-icon`,!this.title&&this.closable&&`${t}-alert--right-adjust`,this.rtlEnabled&&`${t}-alert--rtl`],style:this.cssVars,role:`alert`};return this.visible?(a(),n(`div`,e({key:1},e(this.$attrs,o)),[S(()=>this.closable&&(a(),i(N,{clsPrefix:t,class:w(`${t}-alert__close`),onClick:this.handleCloseClick},null,8,[`clsPrefix`,`class`,`onClick`]))),S(()=>this.bordered&&(a(),n(`div`,{class:w(`${t}-alert__border`)},null,2))),S(()=>this.showIcon&&(a(),n(`div`,{class:w(`${t}-alert__icon`),"aria-hidden":`true`},[S(()=>y(r.icon,()=>[(a(),i(u,{clsPrefix:t},{default:()=>{switch(this.type){case`success`:return a(),i(A,{key:3});case`info`:return a(),i(M,{key:4});case`warning`:return a(),i(O,{key:5});case`error`:return a(),i(D,{key:6});default:return null}}},1032,[`clsPrefix`]))]))],2))),s(`div`,{class:w([`${t}-alert-body`,this.mergedBordered&&`${t}-alert-body--bordered`])},[S(()=>h(r.header,e=>{let r=e||this.title;return r?(a(),n(`div`,{key:2,class:w(`${t}-alert-body__title`)},[S(()=>r)],2)):null})),S(()=>r.default&&(a(),n(`div`,{class:w(`${t}-alert-body__content`)},[S(()=>r.default())],2)))],2)],16)):null}},1032,[`onAfterLeave`])}});export{R as t};