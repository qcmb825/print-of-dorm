...
`,[f(`border`,`
 ...
 `,[d(`& +`,[f(`content`,{marginTop:`9px`})])]),f(`content`,{transition:`color .3s var(--n-bezier)`,fontSize:`var(--n-font-size)`})]),f(`icon`,{transition:`color .3s var(--n-bezier)`})]),L={...x.props,title:String,showIcon:{type:Boolean,default:!0},type:{type:String,default:`default`},bordered:{type:Boolean,default:!0},closable:Boolean,onClose:Function,onAfterLeave:Function,onAfterHide:Function},R=s({name:`Alert`,inheritAttrs:!1,props:L,slots:Object,setup(n){let{mergedClsPrefixRef:r,mergedBorderedRef:i,inlineThemeDisabled:a,mergedRtlRef:o}=_(n),s=x(`Alert`,`-alert`,I,F,n,r),l=w(`Alert`,o,r),u=t(()=>{let{common:{cubicBezierEaseInOut:e},self:t}=s.value,{fontSize:r,borderRadius:i,titleFontWeight:a,lineHeight:o,iconSize:c,iconMargin:l,iconMarginRtl:u,closeIconSize:d,closeBorderRadius:f,closeSize:p,closeMargin:m,closeMarginRtl:h,padding:_}=t,{type:v}=n,{left:y,right:b}=C(l);return{"--n-bezier":e,"--n-color":t[g(`color`,v)],"--n-close-icon-size":d,"--n-close-border-radius":f,"--n-close-color-hover":t[g(`closeColorHover`,v)],"--n-close-color-pressed":t[g(`closeColorPressed`,v)],"--n-close-icon-color":t[g(`closeIconColor`,v)],"--n-close-icon-color-hover":t[g(`closeIconColorHover`,v)],"--n-close-icon-color-pressed":t[g(`closeIconColorPressed`,v)],"--n-icon-color":t[g(`iconColor`,v)],"--n-border":t[g(`border`,v)],"--n-title-text-color":t[g(`titleTextColor`,v)],"--n-content-text-color":t[g(`contentTextColor`,v)],"--n-line-height":o,"--n-border-radius":i,"--n-font-size":r,"--n-title-font-weight":a,"--n-icon-size":c,"--n-icon-margin":l,"--n-icon-margin-rtl":u,"--n-close-size":p,"--n-close-margin":m,"--n-close-margin-rtl":h,"--n-padding":_,"--n-icon-margin-left":y,"--n-icon-margin-right":b}}),d=a?c(`alert`,t(()=>n.type[0]),u,n):void 0,f=e(!0),p=()=>{let{onAfterLeave:e,onAfterHide:t}=n;e&&e(),t&&t()};return{rtlEnabled:l,mergedClsPrefix:r,mergedBordered:i,visible:f,handleCloseClick:()=>{Promise.resolve(n.onClose?.()).then(e=>{e!==!1&&(f.value=!1)})},handleAfterLeave:()=>{p()},mergedTheme:s,cssVars:a?void 0:u,themeClass:d?.themeClass,onRender:d?.onRender}},render(){return this.onRender?.(),i(),o(v,{onAfterLeave:this.handleAfterLeave},{default:()=>{let{mergedClsPrefix:e,$slots:t}=this,s={class:[`${e}-alert`,this.themeClass,this.closable&&`${e}-alert--closable`,this.showIcon&&`${e}-alert--show-icon`,!this.title&&this.closable&&`${e}-alert--right-adjust`,this.rtlEnabled&&`${e}-alert--rtl`],style:this.cssVars,role:`alert`};return this.visible?(i(),r(`div`,a({key:1},a(this.$attrs,s)),[S(()=>this.closable&&(i(),o(M,{clsPrefix:e,class:y(`${e}-alert__close`),onClick:this.handleCloseClick},null,8,[`clsPrefix`,`class`,`onClick`]))),S(()=>this.bordered&&(i(),r(`div`,{class:y(`${e}-alert__border`)},null,2))),S(()=>this.showIcon&&(i(),r(`div`,{class:y(`${e}-alert__icon`),"aria-hidden":`true`},[S(()=>T(t.icon,()=>[(i(),o(k,{clsPrefix:e},{default:()=>{switch(this.type){case`success`:return i(),o(N,{key:3});case`info`:return i(),o(D,{key:4});case`warning`:return i(),o(O,{key:5});case`error`:return i(),o(j,{key:6});default:return null}}},1032,[`clsPrefix`]))]))],2))),n(`div`,{class:y([`${e}-alert-body`,this.mergedBordered&&`${e}-alert-body--bordered`])},[S(()=>l(t.header,t=>{let n=t||this.title;return n?(i(),r(`div`,{key:2,class:y(`${e}-alert-body__title`)},[S(()=>n)],2)):null})),S(()=>t.default&&(i(),r(`div`,{class:y(`${e}-alert-body__content`)},[S(()=>t.default())],2)))],2)],16)):null}},1032,[`onAfterLeave`])}});export{R as t};