import{$ as e,A as t,B as n,Bt as r,C as i,E as a,G as o,J as s,M as c,S as l,St as u,T as d,Tt as f,U as p,Vt as m,X as h,_ as g,_t as _,at as v,d as y,f as b,ht as x,it as S,j as C,st as w,w as T,zt as E}from"./endpoints-NGWT2QHn.js";import{$t as D,A as O,Jt as k,N as A,Xt as j,Zt as M,_ as N,a as P,an as F,b as I,cn as L,ft as R,g as z,h as ee,in as B,it as te,k as V,l as H,ln as ne,lt as U,mt as W,o as re,ot as G,qt as K,t as q,u as J,ut as ie,y as ae}from"./Button-BESWyFjO.js";import{t as oe}from"./Empty-B08g2mL-.js";import{a as se}from"./Scrollbar-DOdDOhFI.js";import{r as ce}from"./cssr-DCvLQij0.js";import{a as le,t as ue}from"./Select-CKklzuPm.js";import{t as Y}from"./FormItem-DleaJ1gt.js";import{t as X}from"./Input-Dz9vPIl-.js";import{n as de,t as fe}from"./DrawerContent-nspkqwXp.js";import{t as pe}from"./Skeleton-Cn9R9FDi.js";import{L as me,m as he,v as ge,y as _e}from"./index-DnFKtpL1.js";import{t as ve}from"./createLucideIcon-DvJrk0KK.js";import{t as ye}from"./inbox-CgSQlRPL.js";import{t as be}from"./lock-Ce97MUt8.js";import{t as xe}from"./plus-DzheAon1.js";import{t as Se}from"./send-DQjeWWsC.js";import{c as Ce,y as we}from"./format-D6sHWZqo.js";import{r as Te,t as Ee}from"./dist-Bq45xLY1.js";var Z=c({name:`SlotMachineNumber`,props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){let t=_(null),r=_(e.value),o=_(e.value),c=_(`up`),d=_(!1),f=l(()=>d.value?`${e.clsPrefix}-base-slot-machine-current-number--${c.value}-scroll`:null),p=l(()=>d.value?`${e.clsPrefix}-base-slot-machine-old-number--${c.value}-scroll`:null);S(u(e,`value`),(e,t)=>{r.value=t,o.value=e,n(m)});function m(){let t=e.newOriginalNumber,n=e.oldOriginalNumber;n!==void 0&&t!==void 0&&(t>n?h(`up`):n>t&&h(`down`))}function h(e){c.value=e,d.value=!1,n(()=>{t.value?.offsetWidth,d.value=!0})}return()=>{let{clsPrefix:n}=e;return s(),a(`span`,{ref:t,class:G(`${n}-base-slot-machine-number`)},[r.value===null?U(()=>null):(s(),a(`span`,{key:0,class:G([`${n}-base-slot-machine-old-number ${n}-base-slot-machine-old-number--top`,p.value])},[U(()=>r.value)],2)),i(`span`,{class:G([`${n}-base-slot-machine-current-number`,f.value])},[i(`span`,{ref:`numberWrapper`,class:G([`${n}-base-slot-machine-current-number__inner`,typeof e.value!=`number`&&`${n}-base-slot-machine-current-number__inner--not-number`])},[U(()=>o.value)],2)],2),r.value===null?U(()=>null):(s(),a(`span`,{key:2,class:G([`${n}-base-slot-machine-old-number ${n}-base-slot-machine-old-number--bottom`,p.value])},[U(()=>r.value)],2))],2)}}}),{cubicBezierEaseOut:Q}=R;function De({duration:e=`.2s`}={}){return[K(`&.fade-up-width-expand-transition-leave-active`,{transition:`
 opacity ${e} ${Q},
 max-width ${e} ${Q},
 transform ${e} ${Q}
