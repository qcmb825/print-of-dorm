import{B as e,Mt as t,Nt as n,P as r,Pt as i,Q as a,U as o,V as s,Y as c,at as l,dt as u,et as d,ft as f,nt as p,ot as m,xt as h,z as g,zt as _}from"./endpoints-6TYL4VMB.js";import{A as v,D as y,Gt as b,Jt as x,Kt as S,T as C,Xt as w,Yt as T,Zt as E,at as D,ft as O,ht as k,it as A,k as j,nn as M,st as N,vt as P}from"./createLucideIcon-BnOls5eb.js";import{a as F,c as I,f as L,i as R,o as z,r as B,s as ee,t as te}from"./create-tAF_5coC.js";import{c as V,n as ne,s as H}from"./Scrollbar-8y1rFSO9.js";import{t as re}from"./use-merged-state-C3te6tKt.js";import{t as ie}from"./format-length-BwSo_EUP.js";import{t as ae}from"./ChevronRight-DZkdE6HD.js";import{A as oe,H as U,T as se,V as ce,dt as le,it as ue,lt as W,st as de,ut as fe}from"./index-BrxHXXHD.js";function pe(e={},r){let i=t({ctrl:!1,command:!1,win:!1,shift:!1,tab:!1}),{keydown:a,keyup:o}=e,s=e=>{switch(e.key){case`Control`:i.ctrl=!0;break;case`Meta`:i.command=!0,i.win=!0;break;case`Shift`:i.shift=!0;break;case`Tab`:i.tab=!0}a!==void 0&&Object.keys(a).forEach(t=>{if(t!==e.key)return;let n=a[t];if(typeof n==`function`)n(e);else{let{stop:t=!1,prevent:r=!1}=n;t&&e.stopPropagation(),r&&e.preventDefault(),n.handler(e)}})},c=e=>{switch(e.key){case`Control`:i.ctrl=!1;break;case`Meta`:i.command=!1,i.win=!1;break;case`Shift`:i.shift=!1;break;case`Tab`:i.tab=!1}o!==void 0&&Object.keys(o).forEach(t=>{if(t!==e.key)return;let n=o[t];if(typeof n==`function`)n(e);else{let{stop:t=!1,prevent:r=!1}=n;t&&e.stopPropagation(),r&&e.preventDefault(),n.handler(e)}})},u=()=>{(r===void 0||r.value)&&(V(`keydown`,document,s),V(`keyup`,document,c)),r!==void 0&&h(r,e=>{e?(V(`keydown`,document,s),V(`keyup`,document,c)):(H(`keydown`,document,s),H(`keyup`,document,c))})};return de()?(l(u),m(()=>{(r===void 0||r.value)&&(H(`keydown`,document,s),H(`keyup`,document,c))})):u(),n(i)}function G(e){return t=>{e.value=t?t.$el:null}}var me=S(`icon`,`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
