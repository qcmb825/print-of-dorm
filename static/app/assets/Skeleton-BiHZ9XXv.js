import{E as e,F as t,J as n,M as r,S as i,_ as a,z as o}from"./endpoints-BqUstzml.js";import{$t as s,F as c,Jt as l,N as u,c as d,it as f,k as p,lt as m,mt as h,qt as g}from"./Button-D6v1m03e.js";var _=!1;function v(){if(d&&window.CSS&&!_&&(_=!0,`registerProperty`in window?.CSS))try{CSS.registerProperty({name:`--n-color-start`,syntax:`<color>`,inherits:!1,initialValue:`#0000`}),CSS.registerProperty({name:`--n-color-end`,syntax:`<color>`,inherits:!1,initialValue:`#0000`})}catch{}}function y(e){let{heightSmall:t,heightMedium:n,heightLarge:r,borderRadius:i}=e;return{color:`#eee`,colorEnd:`#ddd`,borderRadius:i,heightSmall:t,heightMedium:n,heightLarge:r}}var b={name:`Skeleton`,common:u,self:y},x=g([l(`skeleton`,`
 height: 1em;
 width: 100%;
 transition:
